...
func _ready():
	...
	var anomalie_shrek = preload("res://anomalies/anonomalies_level_3/shrek_anomaly_4.tscn").instantiate()
	var anomalie_pitufo = preload("res://anomalies/anonomalies_level_3/pitufo_anomaly_5.tscn").instantiate()
	...
	anomalie_angelique, anomalie_nemo, anomalie_peppa, anomalie_shrek, anomalie_pitufo]
